...
class confettiCannon {
  ...
  clearDrawing(e) {
    ...
    this.showBDMsg(this.startX, this.startY, this.lastDistance)
...
function hideInstructionsOnFirstClick() {
  const instructions = document.getElementById("instructions");
  if (instructions) {
    instructions.style.display = "none";
  }
  document.removeEventListener("click", hideInstructionsOnFirstClick);
}

document.addEventListener("click", hideInstructionsOnFirstClick);
